namespace UI.调度.视频
{
    partial class F视频_录像
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.out来源列 = new DevExpress.XtraGrid.Columns.GridColumn();
            this.out开始时间列 = new DevExpress.XtraGrid.Columns.GridColumn();
            this.out结束时间列 = new DevExpress.XtraGrid.Columns.GridColumn();
            this.out时长列 = new DevExpress.XtraGrid.Columns.GridColumn();
            ...
            // out来源列
            // 
            this.out来源列.Caption = "来源";
            this.out来源列.FieldName = "来源";
            this.out来源列.Name = "out来源列";
            this.out来源列.Visible = true;
            this.out来源列.VisibleIndex = 0;
            this.out来源列.Width = 135;
            // 
            // out开始时间列
            // 
            this.out开始时间列.AppearanceCell.Options.UseTextOptions = true;
            this.out开始时间列.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Near;
            this.out开始时间列.Caption = "开始时间";
            this.out开始时间列.FieldName = "通话类型";
            this.out开始时间列.Name = "out开始时间列";
            this.out开始时间列.OptionsColumn.AllowEdit = false;
            this.out开始时间列.Visible = true;
            this.out开始时间列.VisibleIndex = 1;
            this.out开始时间列.Width = 126;
            // 
            // out结束时间列
            // 
            this.out结束时间列.Caption = "结束时间";
            this.out结束时间列.DisplayFormat.FormatString = "MM-dd HH:mm";
            this.out结束时间列.DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime;
            this.out结束时间列.FieldName = "结束时间";
            this.out结束时间列.Name = "out结束时间列";
            this.out结束时间列.OptionsColumn.AllowEdit = false;
            this.out结束时间列.Visible = true;
            this.out结束时间列.VisibleIndex = 2;
            this.out结束时间列.Width = 126;
            // 
            // out时长列
            // 
            this.out时长列.Caption = "时长(时:分:秒)";
            this.out时长列.FieldName = "时长";
            this.out时长列.Name = "out时长列";
            this.out时长列.OptionsColumn.AllowEdit = false;
            this.out时长列.Visible = true;
            this.out时长列.VisibleIndex = 3;
            this.out时长列.Width = 126;
            // 
            // out操作列4
            // 
            ...
            this.out操作列4.VisibleIndex = 4;
            this.out操作列4.Width = 55;
            // 
            // out操作列1
            // 
            this.out操作列1.Caption = "下载";
            this.out操作列1.Name = "out操作列1";
            this.out操作列1.Visible = true;
            this.out操作列1.VisibleIndex = 5;
            this.out操作列1.Width = 55;
            // 
            // in查询条件
            // 
        ...
        private DevExpress.XtraGrid.Columns.GridColumn out开始时间列;
        private DevExpress.XtraGrid.Columns.GridColumn out结束时间列;
        private DevExpress.XtraGrid.Columns.GridColumn out时长列;
        private DevExpress.XtraGrid.Columns.GridColumn out操作列4;
        private DevExpress.XtraEditors.ButtonEdit in查询条件;
        private DevExpress.XtraGrid.Columns.GridColumn out来源列;
