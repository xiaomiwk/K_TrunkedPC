...
namespace UI.业务.状态
{
    public partial class F地图概览 : UserControl
    {
        private IF地图 _I地图;
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            var __地图标识 = _I地图.添加点(__机房位置, 创建图标("设备", "正常"), "交换");
            _点索引.Add(__地图标识);
            var __数量 = 10;
            var __基站列表 = new List<M经纬度>();
            for (int i = 0; i < __数量; i++)
            {
                ...
                __地图标识 = _I地图.添加点(__基站位置, 创建图标("基站", "正常"), "基站" + i, "基站");
                _点索引.Add(__地图标识);
        ...
        private void _I地图_单击点(object arg1, MouseEventArgs arg2)
        {
            if (arg1.Equals("基站"))
            {
